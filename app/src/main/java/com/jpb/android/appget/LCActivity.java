...
public class LCActivity extends AppCompatActivity {
    ...
    String TextFileURL = "https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/updated_date.txt" ;
    String TextFileURL2 = "https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/version.txt" ;
    String TextFileURL3 = "https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/description.txt" ;
    String TextFileURL4 = "https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/changelog.txt" ;
    TextView textView10;
    TextView textView11;
    TextView textView14;
    TextView textView16;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        installbut.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Uri uri = Uri.parse("https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/foss-release.apk");

                DownloadManager.Request request = new DownloadManager.Request(uri);
                request.setTitle("LibChecker");
                request.setDescription("Downloading");
                request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
                request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "LibChecker.apk");
    ...
    private void readUpdateDate() {
        new Thread() {
            @Override
            public void run() {
                String path ="https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/updated_date.txt";
                URL u = null;
                try {
                    u = new URL(path);
    ...
    private void readVersion() {
        new Thread() {
            @Override
            public void run() {
                String path ="https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/version.txt";
                URL u = null;
                try {
                    u = new URL(path);
                    HttpURLConnection c = (HttpURLConnection) u.openConnection();
    ...
    private void readDescription() {
        new Thread() {
            @Override
            public void run() {
                String path ="https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/description.txt";
                URL u = null;
                try {
                    u = new URL(path);
                    HttpURLConnection c = (HttpURLConnection) u.openConnection();
    ...
    private void readChangelog() {
        new Thread() {
            @Override
            public void run() {
                String path ="https://github.com/jpbandroid/AppGet-Resources/raw/main/LibChecker/changelog.txt";
                URL u = null;
                try {
                    u = new URL(path);
                    HttpURLConnection c = (HttpURLConnection) u.openConnection();
